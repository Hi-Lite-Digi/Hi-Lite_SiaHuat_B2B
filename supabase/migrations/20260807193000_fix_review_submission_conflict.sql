...
begin
  ...
  if new_enquiry_id is null then
    select e.id into new_enquiry_id
    from public.enquiries e
    where e.session_id = trim(request_session_id)
      and e.selected_stock_id = product_record.stock_id
      and e.quantity = request_quantity
